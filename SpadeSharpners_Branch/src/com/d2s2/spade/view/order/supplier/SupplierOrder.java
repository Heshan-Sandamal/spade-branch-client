 ...
 */
public class SupplierOrder extends javax.swing.JDialog {

    /**
     * Creates new form SupplierOrder
     */
    public SupplierOrder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SupplierOrder dialog = new SupplierOrder(new javax.swing.JFrame(), true);
